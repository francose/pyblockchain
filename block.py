...
Author : Sadik Erisen
Date :  Feb.6th 2018
Purpose : This module has two different purpopse. One of the purpopse is to be able to hash the current data and the other purpose is creating an empty constructor for creating a block and linking blocks together.
